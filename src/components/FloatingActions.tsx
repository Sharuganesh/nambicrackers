...
export function FloatingActions({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-28 z-40 mx-auto flex max-w-5xl items-center justify-between px-4">
      <a
        href={`https://wa.me/91${SHOP.phone}`}
        target="_blank"
        rel="noopener"
        aria-label="Chat on WhatsApp"
        className="pointer-events-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-xl"
      >
      ...
      {onCart && (
        <button
          ...
          className="btn-gold pointer-events-auto relative flex h-14 w-14 items-center justify-center rounded-full shadow-xl"
        >
      ...
      <a
        ...
        aria-label="Call us"
        className="pointer-events-auto flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-xl"
      >
