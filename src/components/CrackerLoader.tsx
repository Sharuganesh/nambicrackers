  ...
  return (
    <div className="relative flex h-16 w-16 items-center justify-center">
      <svg viewBox="0 0 64 64" className="chakra-wheel h-14 w-14" aria-hidden="true">
        ...
        <circle cx="32" cy="32" r="18" fill="var(--color-primary)" stroke="var(--color-gold)" strokeWidth="1.5" />
      ...
      <span className="chakra-spark" style={{ "--sa": "0deg" } as React.CSSProperties} aria-hidden="true" />
      <span className="chakra-spark" style={{ "--sa": "60deg", animationDelay: "0.12s" } as React.CSSProperties} aria-hidden="true" />
      <span className="chakra-spark" style={{ "--sa": "140deg", animationDelay: "0.24s" } as React.CSSProperties} aria-hidden="true" />
      <span className="chakra-spark" style={{ "--sa": "210deg", animationDelay: "0.36s" } as React.CSSProperties} aria-hidden="true" />
      <span className="chakra-spark" style={{ "--sa": "290deg", animationDelay: "0.48s" } as React.CSSProperties} aria-hidden="true" />
    ...
    <div className="relative">
      <svg viewBox="0 0 120 52" className="h-12 w-32" aria-hidden="true">
        ...
        <g transform="translate(108 24)">
          <rect x="0" y="6" width="9" height="16" rx="2" fill="var(--color-primary)" stroke="var(--color-gold)" strokeWidth="1.2" />
